  ...
  var e = {
          ...
          s = (function () {
            ...
            return (
              ...
              (e.prototype.shouldFlip = function (e) {
                ...
                return (
                  "auto" === this.position
                    ? (t = !window.matchMedia("(min-height: ".concat(e + 1, "px)"))
                        .matches)
      ...
      799: function (e, t) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          (t.getAdjacentEl = function (e, t, i) {
            void 0 === i && (i = 1);
            for (
              var n = "".concat(i > 0 ? "next" : "previous", "ElementSibling"), r = e[n];
              r;
              ...
              case "ADD_ITEM":
                ...
                return o.choiceId > -1
                  ? e.map(function (e) {
                      var t = e;
                      return (
                        t.id === parseInt("".concat(o.choiceId), 10) && (t.selected = !0),
                        t
                      );
                    })
                  : e;
              case "REMOVE_ITEM":
                ...
                return a.choiceId && a.choiceId > -1
                  ? e.map(function (e) {
                      var t = e;
                      return (
                        t.id === parseInt("".concat(a.choiceId), 10) && (t.selected = !1),
                        t
                      );
                    })
                  : e;
          ...
          (t.default = function (e, n) {
            switch (
              ...
              case "ADD_GROUP":
                ...
                return i(
                  i([], e, !0),
                  [{ id: r.id, value: r.value, active: r.active, disabled: r.disabled }],
                  !1
                );
              case "CLEAR_CHOICES":
                return [];
      ...
      791: function (e, t, i) {
        ...
        function d(e, t, i) {
          ...
          return (
            g({ type: h.INIT }),
            ((n = { dispatch: g, subscribe: v, getState: m, replaceReducer: _ })[c] = y),
            n
          );
        }
        var p = d;
